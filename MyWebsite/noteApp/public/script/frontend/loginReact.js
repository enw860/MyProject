class UserLogIn extends React.Component {
	...
	render() {
		return React.createElement(
			'form',
			{ className: 'myform' },
			React.createElement('span', { id: 'sig_err_message', className: 'err_m' }),
			React.createElement(
				'div',
				{ className: 'inputs' },
				React.createElement('input', { className: 'inputbar', type: 'text', placeholder: 'Email', id: 'input_email', onChange: this.emailOnChange }),
			...
			React.createElement(
				'button',
				{ className: 'submit_button', onClick: this.handelLogin },
				'Log In'
			),
			React.createElement('br', null)
		);
