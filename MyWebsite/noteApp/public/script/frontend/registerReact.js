class RegisteNew extends React.Component {
	...
	render() {
		return React.createElement(
			'form',
			{ id: 'myform', onSubmit: this.handelSubmit },
			React.createElement('span', { id: 'reg_err_message', className: 'err_m' }),
			React.createElement(
				'div',
				{ className: 'inputs' },
				React.createElement('input', { id: 'email', className: 'inputbar', type: 'text', placeholder: 'Email', onChange: this.emailOnChange }),
				' ',
				React.createElement('span', { id: 'checkEmail', className: 'message' }),
				React.createElement('br', null),
				React.createElement('input', { id: 'password', className: 'inputbar', type: 'password', placeholder: 'Password', onChange: this.passwordOnChange }),
				' ',
				React.createElement('span', { id: 'checkPass', className: 'message' }),
				React.createElement('br', null),
				React.createElement('input', { id: 'c-password', className: 'inputbar', type: 'password', placeholder: 'Enter Password Again', onChange: this.checkPasswordOnChange }),
				' ',
				React.createElement('span', { id: 'checkConfirm', className: 'message' }),
				React.createElement('br', null)
			),
			React.createElement(
				'button',
				{ id: 'create-account', className: 'submit_button' },
				'Create Account '
			),
			React.createElement('br', null)
		);
