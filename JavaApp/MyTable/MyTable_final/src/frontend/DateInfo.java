...
public class DateInfo extends Panels{
	...
	private static String[] COSTTITLE = {"Program","Cost","Cash","Visa"};
	private static String[] INCOMETITLE = {"Program","Income","Cash","Visa"};
	...
	public void update() {
		...
		try{bill = TotalBill.makeBills();}
			...
			JOptionPane.showMessageDialog(null,"Load Saving File Error","Error",
		...
		if((b instanceof MonthlyBill)||(b instanceof YearlyBill)){
			...
			balance.setText("");
			resetTable();
			JOptionPane.showMessageDialog(null,"Invalid Bill","Error",
					JOptionPane.ERROR_MESSAGE);
		}
	}
